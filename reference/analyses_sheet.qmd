...
![Pick your analysis!](../images/im-060-analysis-and-graphs-sheet.png)

## Global Summary

![](../images/im-061-global-summary.png)
...
[^1]: As in the dictionary, the function must be written in English, regardless of the language in which the rest of the setup is written.

### Example

Definition in the **setup file**:

![](../images/im-062-example-global-summary.png)

Display in the **linelist**:

![](../images/im-063-example-global-summary.png)

## Univariate Analysis

![](../images/im-064-univariate-analysis.png)
...
![](../images/im-065-univariate-analysis.png)

### Example

![](../images/im-066-example-univariate-analysis.png)

Definition in the **setup file**:

Display in the linelist:

![](../images/im-067-example-univariate-analysis.png)
...
![](../images/im-068-bivariate-analysis.png)
...
![](../images/im-069-example-bivariate-analysis.png)

Display in the linelist :

![](../images/im-070-example-bivariate-analysis.png)
...
![](../images/im-071-time-series-analysis.png)
...
![](../images/im-072-labels-for-time-series-graphs.png)
...
![](../images/im-073-graph-on-time-series.png)
...
![](../images/im-074-example-graph-on-time-series.png)

Definition in the **setup file**:

![](../images/im-075-example-graph-on-time-series.png)

Display in the linelist:

![](../images/im-076-example-graph-on-time-series.png)

![](../images/im-077-example-graph-on-time-series.png)

![](../images/im-078-example-graph-on-time-series.png)

### Diagrams

![](../images/im-079-diapgram.png)

![](../images/im-080-diapgram.png)

## Spatial Analysis

![](../images/im-081-spatial-analysis.png)
...
Definition in the **setup file**: ![](../images/im-082-example-spatial-analysis.png)

Display in the linelist: ![](../images/im-083-example-spatial-analysis.png)
...
![](../images/im-084-specification-for-spatio-temporal-analysis.png)
...
![](../images/im-085-spatio-temporal-analysis.png)
...
![](../images/im-086-example-spatio-temporal-analysis.png)

Display in the **linelist file**:

![](../images/im-087-example-spatio-temporal-analysis.png)
