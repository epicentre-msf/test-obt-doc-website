...
![](../images/im-088-exports-sheet.png)
...
![](../images/im-089-export-number.png)

![](../images/im-090-export-number.png)

Note that you can use the "*Add rows to table in current sheet*" button or the "*Resize tables in current sheet*" button to add more exports or removed empty rows (see the [ribbon help](../reference/ribbons.qmd#sec-setup-ribbon).
...
![](../images/im-091-status-exports-sheet.png)

Display in the **linelist file**:

![](../images/im-092-status-exports-sheet.png)
...
![](../images/im-093-label-button-exports-sheet.png)

Display in the **linelist file**:

![](../images/im-094-label-button-exports-sheet.png)
...
![](../images/im-095-example-file-name.png)
...
![](../images/im-096-example-password.png)

Display in the **linelist file**:

![](../images/im-097-example-password.png)

![](../images/im-098-example-password.png)
...
![](../images/im-099-example-header-format.png)

Display in export:

![](../images/im-100-example-header-format.png)

Definition in the **setup file**:

![](../images/im-101-example-header-format.png)

Display in export:

![](../images/im-102-example-header-format.png)
