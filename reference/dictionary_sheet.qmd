...
## Use editable labels to add customisable variables in your linelists
...
-   *hidden*: variable hidden by default, it cannot be displayed in the linelis
...
::: {.callout-note}
## Note: cannot be used for analyses
...
In the case of "list auto" variables, you only need to provide the *name of another variable* in the "Control details" column. In the linelist, the values present in the referred variable will be automatically used to populate the dropdown menu. See [this How to](../how_to/link_tables.qmd#sec-ht-list_auto) for an example.
