...
The column headings can be modified. It is better to name the languages in the table headings, as they will be used to populate a dropdown menu later, when the linelist is created.
