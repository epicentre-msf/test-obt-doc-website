...
2. Go to the [OutbreakTools menu](../getting_started/workflow.qmd#fig-setup-ribbon) of this setup file and click on the button "Import data from another setup".
...
4. Decide if you want to run a checkup of the **setup** file after import by ticking the box or not (you probably want to, but you can also [do it](../reference/ribbons.qmd#sec-check-setup) at a later stage)
