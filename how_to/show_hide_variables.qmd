...
In OutbreakTools, there are several visibility status, which can be modified using a button in the [OutbreakTools Menu](../reference/ribbons.qmdsec-linelist-ribbon):
