...
OutbreakTools linelists have functionalities to export data. OutbreakTools linelists developed by the EpiDS team are usually paired with a dashboard, at least in the case of intersection linelists or big multi-sections  projects. As a consequence, all linelists created by the EpiDS team can generate password-protected anonymous data, ready to be sent to Epicentre for compilation and visualisation.
...
4.	Export data using the "Export data" button of the [OutbreakTools menu](../setup_reference/ribbons.qmd#sec-export-data), and chose the “Anonymous export to MSF” option (or a similar name). You will be prompted for a place to save the genarated export.
