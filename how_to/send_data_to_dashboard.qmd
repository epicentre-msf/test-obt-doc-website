...
- Export data using the "Export data" button of the [OutbreakTools menu](../setup_reference/ribbons.qmd#sec-export-data), and chose the “Anonymous export to MSF” option (or a similar name). You will be prompted for a place to save the genarated export.
