...
[^2]: These variables can take only one value, see [the different sorts of tables](../setup_reference/dictionary_sheet.qmd#sec-sheet-types) for more information.
...
See the page on [formulas](../setup_reference/dictionary_sheet.qmd#sec-formula) and [formulas controls](../setup_reference/dictionary_sheet.qmd#sec-formula-control)
...
Seethe section on [list_auto](/setup_reference/dictionary_sheet.qmd#sec-list-auto) and its [control](../setup_reference/dictionary_sheet.qmd#sec-var-control-details) for a description on how to use the **list_auto** control.
