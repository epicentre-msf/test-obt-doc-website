...
[^2]: These variables can take only one value, see [the different sorts of tables](../reference/dictionary_sheet.qmd#sheet-types) for more information.
...
See the page on [formulas](../reference/dictionary_sheet.qmd#formula) and [formulas controls](../reference/dictionary_sheet.qmd#formula-control)
...
Seethe section on [list_auto](/reference/dictionary_sheet.qmd#list-auto) and its [control](../reference/dictionary_sheet.qmd#var-control-details) for a description on how to use the **list_auto** control.
