...
5. Clicking the "Download Geobase" button to download the data for the selected regions in an excel format that can be directly imported into an OutbreakTools Linelist.
...
1. Open the linelist
2. Go to the [OutbreakTools Menu](../setup_reference/ribbons.qmdsec-linelist-ribbon)
3. Click on the ["Import geobase" button](../setup_reference/ribbons.qmd#sec-import-geobase)
