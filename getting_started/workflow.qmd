...
The **setup file** also has a dedicated OutbreakTools section in the top option ribbon from Excel:

![OutbreakTools ribbon in the **setup file**](images/img-002-ribbon-linelist.png){alt="OutbreakTools ribbon in th" fig-align="center"}
