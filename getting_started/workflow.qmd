...
5.  Rince and repeat until the linelist is functional
...
| Analysis   | Describes the analyses to include is the linelist in tabular form, by selecting the variables and indicating the formulas to be applied | Analysis sheets                                                   |
...
When the **setup file** is ready (or at least a first draft is), you load it into a **designer**, fill a couple of fields^[What is the name of the created linelist, where to save it, should it be password protected and if yes, which password etc.] and let the designer build the linelist.
