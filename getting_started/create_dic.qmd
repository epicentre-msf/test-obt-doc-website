...
To do that, go to the "Advanced" section of the [OutbreakTools ribbon](../reference/ribbons.qmd#sec-linelist-ribbon) and click on the "Export for migration" button. This will create a data export, that can be later imported in a new empty linelist by clicking on the "Import data" button from the same ribbon.
:::