...
[Download](../getting_started/download.qmd#download) the files from github to get the most updated versions and unzip it.
...
Fill the *Analysis* sheet to **define basic analyses** to include in the linelist:
...
To do that, go to the "Advanced" section of the OutbreakTools ribbon and click on the "Export for migration" button. This will create a data export, that can be later imported in a new empty linelist by clicking on the "Import data" button.
:::