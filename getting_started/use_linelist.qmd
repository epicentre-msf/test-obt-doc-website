...
4. Optional: modify variable visibility: "Show/Hide variables" button from the [OutbreakTools menu](../reference/ribbons.qmd#sec-linelist-ribbon)  

5.	Optional: prepare and print a register and/or Case Report Form to enter data on paper ("Register and Case report form" section of the [OutbreakTools menu](../reference/ribbons.qmd#sec-linelist-ribbon))
