...
2.	[Prepare geographic information](../how_to/import_geobase.qmd):
    ...
    b)	In the linelist, go to the [OutbreakTools menu](../setup_reference/ribbons.qmd#sec-linelist-ribbon) and click on the ["Import geobase" button](../setup_reference/ribbons.qmd#sec-import-geobase)  
  
  
3.	Set up the day of the week: "Week start" button in the [OutbreakTools menu](../setup_reference/ribbons.qmd#sec-linelist-ribbon)

4. Optionaly: modify variable visibility: "Show/Hide variables" button from the [OutbreakTools menu](../setup_reference/ribbons.qmd#sec-linelist-ribbon)  

5.	Optionaly: prepare and print a register and/or Case Report Form to enter data on paper ("Register and Case report form" section of the [OutbreakTools menu](../setup_reference/ribbons.qmd#sec-linelist-ribbon))
...
Most of the important features of the linelist can be accessed through the [OutbreakTools Menu](../setup_reference/ribbons.qmd#sec-linelist-ribbon) at the top of Excel interface. Go and explore it!
...
You can fill the variables either by using the cascading dropdown menus, or by using the [GeoHelper button](../setup_reference/ribbons.qmd#sec-geo-helper) from the OutbreakTools menu.

:::{.callout-note title="Search options in the Geohelper"}
The first tab of the [GeoHelper popup window](../setup_reference/ribbons.qmd#sec-geo-helper) allows you to pick the location level after level; the second tab allows you to search for a name in the geobase and the third tab displays the past values previously picked in the GeoHelper.
:::
