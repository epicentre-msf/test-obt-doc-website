...
2.	[Prepare geographic information](../how_to/import_geobase.qmd):
    ...
    b)	In the linelist, go to the [OutbreakTools menu](../reference/ribbons.qmd#sec-linelist-ribbon) and click on the ["Import geobase" button](../reference/ribbons.qmd#sec-import-geobase)  
  
  
3.	Set up the day of the week: "Week start" button in the [OutbreakTools menu](../reference/ribbons.qmd#sec-linelist-ribbon)

4. Optionaly: modify variable visibility: "Show/Hide variables" button from the [OutbreakTools menu](../reference/ribbons.qmd#sec-linelist-ribbon)  

5.	Optionaly: prepare and print a register and/or Case Report Form to enter data on paper ("Register and Case report form" section of the [OutbreakTools menu](../reference/ribbons.qmd#sec-linelist-ribbon))
...
To avoid synchronization problems, it is advised that you do not synchronise it with OneDrive while the Excel file is opened.
...
1.	Make sure the file is not *protected*^[This is distinct from the password protection that is customs for linelists: sometimes when a file comes from the internet through mail or Teams, Windows applies an extra layer of blocking]: right click on the file you saved on your computer, and go to the “Properties” popup. If you can see an “Unprotect” checkbox at the bottom right, tick it. If you do not see such a checkbox, it means the file is unprotected.
...
Most of the important features of the linelist can be accessed through the [OutbreakTools Menu](../reference/ribbons.qmd#sec-linelist-ribbon) at the top of Excel interface. Go and explore it!
