...
### Change style
You can select the other "Linelist design" using the dropdown menu (see the [ribbon](../setup_reference/ribbons.qmd#sec-setup-styles) to import your own style)
...
There are a couple more customisations available through the [OutbreakTools option ribbon](../setup_reference/ribbons.qmd#sec-designer-ribbon).
...
- [Run the checks](../setup_reference/ribbons.qmd#sec-check-setup) on the setup before attempting compilation to verify that everything is ready.
