...
![](../setup_reference/images/im-088-exports-sheet.png){fig-align="center"}
...
![](../setup_reference/images/im-089-export-number.png){fig-align="center"}

![](../setup_reference/images/im-090-export-number.png){fig-align="center"}

Note that you can use the "*Add rows to table in current sheet*" button or the "*Resize tables in current sheet*" button to add more exports or removed empty rows (see the [ribbon help](../setup_reference/ribbons.qmd#sec-setup-ribbon).
...
![](../setup_reference/images/im-091-status-exports-sheet.png){fig-align="center"}

Display in the **linelist file**:

![](../setup_reference/images/im-092-status-exports-sheet.png){fig-align="center"}
...
![](../setup_reference/images/im-093-label-button-exports-sheet.png){fig-align="center"}

Display in the **linelist file**:

![](../setup_reference/images/im-094-label-button-exports-sheet.png){fig-align="center"}
...
![](../setup_reference/images/im-095-example-file-name.png){fig-align="center"}
...
![](../setup_reference/images/im-096-example-password.png){fig-align="center"}

Display in the **linelist file**:

![](../setup_reference/images/im-097-example-password.png){fig-align="center"}

![](../setup_reference/images/im-098-example-password.png){fig-align="center"}
...
![](../setup_reference/images/im-099-example-header-format.png){fig-align="center"}

Display in export:

![](../setup_reference/images/im-100-example-header-format.png){fig-align="center"}

Definition in the **setup file**:

![](../setup_reference/images/im-101-example-header-format.png){fig-align="center"}

Display in export:

![](../setup_reference/images/im-102-example-header-format.png){fig-align="center"}
