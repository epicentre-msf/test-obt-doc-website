...
![](../setup_reference/images/im-061-global-summary.png)
...
-   **Summary function**: free text field for entering the *Excel formula* that will display the desired indicator. See the [formula specifications here](../setup_reference/dictionary_sheet.qmd#sec-formulas).

-   **Format**: dropdown menu for defining the **display format* of the expected result (see variable [format](../setup_reference/dictionary_sheet.qmd#sec-var-format))

### Example

Definition in the **setup file**:

![](../setup_reference/images/im-062-example-global-summary-en.png){fig-align="center"}

Display in the **linelist**:

![](../setup_reference/images/im-063-example-global-summary-en.png){fig-align="center"}

## Univariate Analysis

The "Univariate Analysis" table is used to describe analyses based on a single variable.

![](../setup_reference/images/im-064-univariate-analysis.png){fig-align="center"}
...
**Summary function**: this is a free field in which to enter the *formula* corresponding to the desired analysis. The formula must always be written without the "=" sign and in English, whatever the language in which the **setup file** is written (see the [formula specifications here](../setup_reference/dictionary_sheet.qmd#sec-formulas) for more informations on formulas).
...
**Format**: this is a static dropdown menu with a pre-selection of possible display formats (see variable [format](../setup_reference/dictionary_sheet.qmd#sec-var-format) for more information)
...
![](../setup_reference/images/im-065-univariate-analysis.png){fig-align="center"}
:::
...
![](../setup_reference/images/im-066-example-univariate-analysis.png){fig-align="center"}

Definition in the **setup file**:

Display in the **linelist**:

![](../setup_reference/images/im-067-example-univariate-analysis.png){fig-align="center"}
...
![](../setup_reference/images/im-068-bivariate-analysis.png){fig-align="center"}
...
![](../setup_reference/images/im-069-example-bivariate-analysis.png){fig-align="center"}

Display in the **linelist**:

![](../setup_reference/images/im-070-example-bivariate-analysis.png){fig-align="center"}
...
![](../setup_reference/images/im-071-time-series-analysis.png){fig-align="center"}
...
**Summary function**: this is a free field in which to enter the formula corresponding to the desired analysis. The formula must always be written without the "*=*" sign and in English, whatever the language in which the **setup file** is written (See the [formula specifications here](../setup_reference/dictionary_sheet.qmd#sec-formulas) for more information).
...
**Format**: this is a static dropdown menu with a preselection of possible display formats (see variable [format](../setup_reference/dictionary_sheet.qmd#sec-var-format) for more information).
...
![](../setup_reference/images/im-072-labels-for-time-series-graphs.png){fig-align="center"}
...
![](../setup_reference/images/im-073-graph-on-time-series.png){fig-align="center"}
...
![](../setup_reference/images/im-074-example-graph-on-time-series.png){fig-align="center"}

Definition in the **setup file**:

![](../setup_reference/images/im-075-example-graph-on-time-series.png){fig-align="center"}

Display in the **linelist**:

![](../setup_reference/images/im-076-example-graph-on-time-series.png){fig-align="center"}

![](../setup_reference/images/im-077-example-graph-on-time-series.png){fig-align="center"}

![](../setup_reference/images/im-078-example-graph-on-time-series.png){fig-align="center"}
...
![](../setup_reference/images/im-081-spatial-analysis.png){fig-align="center"}
...
**Geo/HF variable (row)**: this is a dynamic dropdown menu containing all variables of type ["hf" or "geo"](../setup_reference/dictionary_sheet.qmd#sec-geo-data).
...
**Format**: this is a static dropdown menu containing a pre-selection of possible display formats (see variable [format](../setup_reference/dictionary_sheet.qmd#sec-var-format) for more information).
...
![](../setup_reference/images/im-082-example-spatial-analysis.png){fig-align="center"}

Display in the **linelist**:

![](../setup_reference/images/im-083-example-spatial-analysis.png){fig-align="center"}
...
![](../setup_reference/images/im-084-specification-for-spatio-temporal-analysis.png){fig-align="center"}
...
**Spatial type**: this is a static dropdown menu with two options, *geo* or *hf*. This defines the type of [geographic variable](../setup_reference/dictionary_sheet.qmd#sec-geo-data) to be used in the section (a geo variable or a health facility).


### Spatio-Temporal Analysis

![](../setup_reference/images/im-085-spatio-temporal-analysis.png){fig-align="center"}
...
![](../setup_reference/images/im-086-example-spatio-temporal-analysis.png){fig-align="center"}

Display in the **linelist file**:

![](../setup_reference/images/im-087-example-spatio-temporal-analysis.png){fig-align="center"}
