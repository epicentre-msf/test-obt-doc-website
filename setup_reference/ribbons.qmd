...
This section provides functionalities for the [Translation sheet](../setup_reference/translations_sheet.qmd).
...
![Message of end of translation update](../setup_reference/images/im-112-translations-sheet.png){fig-align="center"}

Go to the [Translation sheet](../setup_reference/translations_sheet.qmd) for more information on translations.
...
![Buttons acting on data entry tables](../setup_reference/images/img-006-ll-table-management.png){fig-align="center"}

#### Show / Hide variables

Clicking on the "Show/hide variables" button opens a window listing all the variables in this linelist sheet. 

![Show hide button and pop-up window](../setup_reference/images/img-012-ll-show-hide.png){fig-align="center"}
...
![Refresh analyses button](../setup_reference/images/img-007-ll-refresh-analyses.png){fig-align="center"}
...
![Imports section](../setup_reference/images/img-008-ll-imports.png){fig-align="center"}
...
![Register and case report form section](../setup_reference/images/img-010-ll-register.png){fig-align="center"}
...
![Advanced button and pop-up window](../setup_reference/images/img-011-ll-advanced.png){fig-align="center"}
...
![Export for migration](../setup_reference/images/img-013-ll-export-migration.png){fig-align="center"}
