...
The columns [Control](#sec-var-control) together with [Control details](#sec-var-control-details) are use to constrain the values that a text variable can take, or provide with a formula in the case of a calculated variable.
