...
The columns [Control](#sec-var-control) together with [Controd details](#sec-var-control-details) are use to constrain the values that a text variable can take, or provide with a formula in the case of a calculated variable.
...
## Guide to choosing variable control
