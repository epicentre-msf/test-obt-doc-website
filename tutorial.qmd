...
::: {.callout-note}
If you just want to focus on linelist usage, you can download *materials for a short tutorial* [available here](https://github.com/epicentre-msf/outbreak-tools-demo/raw/main/demo_materials_usage.zip)
:::
...
Sometimes Excel files with macro downloaded from the web are automatically blocked for security reasons. You can unblock the files by:

1. Right click on the file
2. Select "Properties"
3- Check the *Unblock* box on the bottom right.
